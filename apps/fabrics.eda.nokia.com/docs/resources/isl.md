...
crd_path: docs/fabrics.eda.nokia.com/crds/fabrics.eda.nokia.com_isls.yaml
...
In addition to modelling physical connectivity between switches, the `ISL` resource is responsible for the configuration of [underlay](../../../routing.eda.nokia.com/docs/index.md) protocols like [BGP](../../../protocols.eda.nokia.com/docs/resources/defaultbgppeer.md) and [OSPF](../../../protocols.eda.nokia.com/docs/resources/defaultospfinterface.md) for the exchange of [underlay routes](../../../routing.eda.nokia.com/docs/index.md).
